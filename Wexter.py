...
{Fore.RED}[1] {Fore.GREEN}Nuke a targetted account.
{Fore.RED}[2] {Fore.GREEN}Get information from a targetted account.
{Fore.RED}[3] {Fore.GREEN}Log into an account.
{Fore.RED}[4] {Fore.GREEN}Exit.{Style.RESET_ALL}
